...
- **`qa-financas`** (usada na [[../../QA Workspace/00 Inbox/Planejamento Financeiro Consolidado (Out 2026 – Mar 2027)|Planejamento Financeiro]]): cor por linha no checklist — linhas marcadas `[x]` ficam verdes (`#16a34a`), checkbox na mesma cor. A cor acompanha o status por linha (pago/quitação), não o bloco; os callouts do mês ficam neutros.
