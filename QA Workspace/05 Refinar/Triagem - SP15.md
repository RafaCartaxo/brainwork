...
> [!warning] Este arquivo foi migrado para Planejamento em 2026-07-25
> A triagem agora é uma página única em [[../Planejamento/SP15|Planejamento/SP15]].
...
> [!tip] Progresso: **44/82** batidos (53 no export original + 11 preservados fora do corte + SGV-8574 + 17 itens novos da view "Release: 23/07/2026 12.35.36.2" — atualizado 2026-07-24)
> Homologação `7/10` · Teste dev `6/11` · Testando HML `1/2` · Revisar MR `5/8` · Em dev `1/3` · Impedimento/CX `1/4` · Não reproduzido `1/6` · Backlog `0/2` · Aprovado no Dev `1/1` · Produção/Aprovado `16/24` · Fora do export `5/11`
...
- [x] **[[QA Workspace/02 Demandas/Concluídas/5269 - Bug Botão Recuperar Senha Não Redireciona|SGV-5269]]** — Botão de recuperar senha não redireciona para o fluxo de esqueci senha ✅ 2026-07-24 → **aprovada em HML**, card criado em Concluídas
...
- 2026-07-24 - **7829** (Em impedimento) → validada em HML: **atendimento parcial** (PDF ok, imagem não carrega) — 🔴 reaberta, sem bloqueio de publicação. Card criado em `02 Demandas/HML/`. Contador inalterado (já batida desde 17/07).
- 2026-07-24 - Batida (44/82): **5269** (novo, Disponível para homologação) → **aprovada em HML**, card criado em `02 Demandas/Concluídas/`. Homologação 6/10→7/10.
