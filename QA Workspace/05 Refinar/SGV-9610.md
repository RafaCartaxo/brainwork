...
Quem participa de mais de um setor não consegue associar um documento na hora de criar um documento novo: se o documento que ele quer associar é de um setor que ele participa mas não é o que está usando no momento, a busca simplesmente não encontra o documento. Pelo despacho, a mesma busca funciona normal. (Reportado pela PM Guamaré; corrigido no MR !537 — a busca da abertura estava sendo feita sem informar o setor do usuário.)

### Passo a passo para reproduzir

**Dado** que sou um servidor que participa de dois setores (A e B) e estou usando o sistema pelo setor A
**Quando** começo a criar um documento novo e, em "Associar documentos", busco um documento que eu consigo acessar pelo setor B
**Então** o documento não aparece na lista pra eu associar

*(Cenário original do cliente: PM Guamaré, setor SEMAVM, memorando, busca pelo Ofício 001839/2025.)*

### Resultado Esperado

Se o servidor tem acesso ao documento — não importa por qual dos setores dele —, o documento aparece na busca e dá pra associar na abertura.

### Critérios de aceite

- [ ] **O bug sumiu**: participando dos setores A e B, e usando o sistema pelo A, encontro na abertura um documento que é do setor B
- [ ] **O básico continua funcionando**: documento do próprio setor que estou usando continua aparecendo na busca
- [ ] **Mesma busca nos dois lugares**: o que eu encontro associando pelo despacho, encontro também associando na abertura
- [ ] **Não abriu demais**: documento que eu não tenho acesso por nenhum setor meu continua sem aparecer (a correção não pode ter liberado a busca pra tudo)
- [ ] **Nada quebrou do lado**: associar pelo despacho e assinar pela toolbar continuam funcionando, inclusive pra quem participa de vários setores (o MR mexeu nessas telas também)
