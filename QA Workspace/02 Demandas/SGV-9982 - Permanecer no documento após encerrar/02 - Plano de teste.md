...
- **Fora do escopo desta rodada:** copy/estilo exato dos dialogs (C9), acessibilidade (RNF07), variante mobile (RNF08) e verificação de que a gravação não entra no histórico do documento (RNF05) — ficam para uma rodada seguinte, junto com o requisito condicional RF11 (pendência 1, ver `01 - Demanda`).
...
Camada não aplicável nesta rodada: acessibilidade e mobile dedicados (ficam para a rodada seguinte, junto com C9/RNF05/RNF07/RNF08).
...
**Saída:** os 11 CTs executados e registrados em `04 - Validação dev`, com resultado geral definido (aprovado / reprovado / aprovado com ressalvas).
