...
- **Relacionado**: [[QA Workspace/02 Demandas/Concluídas/5152/QA/5152 - Funcionalidade Cancelar E Retificar Despacho|SGV-5152]] — a funcionalidade de retificação de despacho é dessa entrega, já concluída. Este bug é sobre o comportamento em homologação, não um defeito da 5152 (não saiu da execução dos CTs dela).
- Observações:
