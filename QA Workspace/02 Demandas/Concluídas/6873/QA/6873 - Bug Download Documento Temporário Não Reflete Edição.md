...
- Histórico:
    ...
    - 2026-07-24 - ✅ Resolvida **por herança**: fix da 6873 mergeado em `fix/6083` e validado via a aprovação da [[QA Workspace/02 Demandas/Concluídas/6083/QA/6083 - Bug Edição Documento Não Atualiza Download Assinatura|SGV-6083]] em homologação. Sem validação funcional independente; MR superseded pelo merge.
