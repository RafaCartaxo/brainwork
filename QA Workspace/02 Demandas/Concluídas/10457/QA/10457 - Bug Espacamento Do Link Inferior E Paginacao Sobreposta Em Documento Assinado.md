...
1. **Espaçamento não respeitado** — além do link na vertical já tratado na [[QA Workspace/02 Demandas/Concluídas/9405/QA/9405 - Bug Desalinhamento Link QR Code Página Assinatura Separada|SGV-9405]], existe **outro link na parte inferior** cujo espaçamento não está sendo respeitado.
...
- **Relação com a [[QA Workspace/02 Demandas/Concluídas/9405/QA/9405 - Bug Desalinhamento Link QR Code Página Assinatura Separada|SGV-9405]]** — a 9405 tratou o link **na vertical** e está aprovada em DEV com `deploy: pendente_hml`. Este card é o link da **parte inferior**, ou seja **outro elemento**, não reincidência do mesmo. Duas leituras a confirmar no diagnóstico:
...
- **Vizinhança no download personalizado**: a opção "personalizado" é a mesma família de [[QA Workspace/02 Demandas/Concluídas/6628/QA/6628 - Bug Selecionar Todos Download Documentos Personalizados|SGV-6628]] (selecionar todos no download personalizado) e de [[QA Workspace/02 Demandas/Concluídas/10404/QA/10404 - Bug Download Assinaturas Autenticaveis Ignora Pagina Extra Assinaturas|SGV-10404]] (autenticáveis ignoram a página extra). **Três bugs distintos no mesmo menu de download** — se o time for mexer ali, vale olhar os três juntos.
- Histórico:
