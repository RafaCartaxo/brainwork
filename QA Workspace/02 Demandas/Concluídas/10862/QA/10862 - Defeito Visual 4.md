...
ambiente: DEV
---
# Defeito visual 4 — layout da mesa de trabalho mobile
...
>
> **Numeração `4` é só identificação** — segue a ordem crescente de SGV entre os 4 defeitos da task, não prioridade nem ordem de descoberta.
