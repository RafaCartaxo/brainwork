...
>
> **Parte 2** de duas — irmã de [[QA Workspace/02 Demandas/Concluídas/11083/Conhecimento/2 - SGV-11083 - Refinamento Departamentos Para Cidadao PJ|SGV-11083 (Parte 1)]], sob a mesma epic pai [[QA Workspace/02 Demandas/Concluídas/9296/Conhecimento/0 - SGV-9296 - Índice|SGV-9296]].
...
- **Gap de cobertura exposto pelo defeito [[QA Workspace/02 Demandas/Concluídas/11319/QA/11319 - Defeito Departamento Nao E Persistido Ao Retificar Despacho|SGV-11319]]** (corrigido e aprovado em DEV, 03/09/2026): nenhum RF/CA cobre retificação de despacho — a tela de retificação não preservava o departamento selecionado como destinatário, mostrando o cidadão PJ/empresa no lugar. Ancorado em [[QA Workspace/04 Conhecimento/Módulos/Despachos#Retificar despacho|Despachos.md]] ("campos editáveis: destinatários" pressupõe mostrar o valor atual real). Segue faltando decidir se vira RF/CA e CT formal.
...
- 2026-09-03 - 🐛 Defeito cadastrado (achado em teste exploratório): [[QA Workspace/02 Demandas/Concluídas/11319/QA/11319 - Defeito Departamento Nao E Persistido Ao Retificar Despacho|SGV-11319]] — departamento não persistido ao retificar despacho, gap de cobertura (sem CT de retificação)
- 2026-09-03 - ✅ [[QA Workspace/02 Demandas/Concluídas/11319/QA/11319 - Defeito Departamento Nao E Persistido Ao Retificar Despacho|SGV-11319]] aprovado em DEV (corrigido, reteste OK)
...
- 2026-09-03 - 🔎 CT-018 corrigido: mencionava "departamento ou seus membros" recebendo a notificação com URL externa, sem base no RF04 (que fala só do departamento). O e-mail com URL externa de rastreabilidade (RF04) vai só pro endereço do departamento; a notificação **interna** por membro (RF03 CA02) é canal separado, sem essa URL. "Participantes não implementado" (bullet acima) vale pra exibição/seleção como destinatário, não pra notificação interna — essa já existe e está em escopo (RF03 CA02).
