...
- **Relacionado**: [[QA Workspace/02 Demandas/Concluídas/9405/QA/9405 - Bug Desalinhamento Link QR Code Página Assinatura Separada|SGV-9405]] — mesma área (página extra/separada de assinaturas), problema diferente: lá era desalinhamento do link e QR Code **dentro** da página extra (aprovado em DEV hoje), aqui a página extra **nem é gerada** no download de autenticáveis.
