...
ambiente: DEV
---
# Defeito visual 3 — layout da mesa de trabalho mobile
...
>
> **Numeração `3` é só identificação** — segue a ordem crescente de SGV entre os 4 defeitos da task, não prioridade nem ordem de descoberta.
