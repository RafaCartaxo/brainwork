...
Ciclo de vida das demandas de teste.

| Subpasta | Finalidade |
|----------|------------|
| DEV | Testes em ambiente de desenvolvimento — uma nota por demanda, com o template apropriado |
| HML | Testes em homologação — deve refletir o cenário mais próximo possível de produção |
| Hotfix | Correções urgentes — validadas em ambiente de homologação com a versão de produção + a hotfix |
