...
- **Cidadão Interage Somente na Abertura do Processo** (checkbox): herda o status do módulo vinculado, editável na criação/edição; exibido só se "Permite abertura externa" estiver habilitado.
