...
- [ ] **Alteração de e-mail: qual o retorno esperado quando a senha de confirmação está incorreta?** Esta doc descreve as etapas de e-mail e de senha, mas não diz nada sobre o feedback de senha inválida — lacuna encontrada no gate de doc da [[QA Workspace/02 Demandas/DEV/10549 - Bug Senha Incorreta Nao Retorna Feedback Na Alteracao De E-mail Do Cidadao PJ|SGV-10549]] (03/08/2026, reproduz em DEV e homologação, cidadão PJ). O respaldo hoje é **analogia** com o [[QA Workspace/04 Conhecimento/Módulos/Login|Login]], que documenta mensagem de erro para credencial inválida — não regra escrita pra esta tela
- [ ] **A tentativa de senha na alteração de e-mail conta pro bloqueio por 5 erros?** O [[QA Workspace/04 Conhecimento/Módulos/Login|Login]] registra que 5 senhas erradas bloqueiam a conta em todos os ambientes. Se essa tela contar, o usuário pode bloquear a própria conta sem receber aviso nenhum (ver [[QA Workspace/02 Demandas/DEV/10549 - Bug Senha Incorreta Nao Retorna Feedback Na Alteracao De E-mail Do Cidadao PJ|SGV-10549]]). Decisão de produto pendente — documentar a regra quando vier
- [ ] **O mesmo silêncio acontece no cidadão PF e no servidor?** Só o PJ foi observado. Se acontecer nos três, o defeito é da etapa de confirmação por senha, não do fluxo PJ, e o alcance da correção muda
